...
import type { Amount, AmountOf, AuctionDetails, AuctionId, CID, ClassData, ClassIdOf, ClassInfoOf, CurrencyId, CurrencyIdOf, DomainInfo, Order, OrderId, OrderOf, PoolDetails, Properties, TokenData, TokenId, TokenIdOf, TokenInfoOf, TokenSymbol } from 'domain-types/interfaces/default';
