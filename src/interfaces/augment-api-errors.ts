...
declare module '@polkadot/api/types/errors' {
  export interface AugmentedErrors<ApiType> {
    auction: {
      AuctionExpired: AugmentedError<ApiType>;
      AuctionStarted: AugmentedError<ApiType>;
      ExceedMaxAuction: AugmentedError<ApiType>;
      InvalidBidAmount: AugmentedError<ApiType>;
      InvalidCreator: AugmentedError<ApiType>;
